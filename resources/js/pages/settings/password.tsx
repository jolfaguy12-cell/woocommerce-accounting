        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <SettingsLayout>
                <div className="space-y-6">
                    <HeadingSmall title="تغییر رمز عبور" description="برای امنیت حساب، از رمز عبور طولانی و تصادفی استفاده کنید" />
                    ...
                    <form onSubmit={updatePassword} className="space-y-6">
                        ...
                        <div className="flex items-center gap-4">
                            <Button disabled={processing}>ذخیره رمز عبور</Button>
