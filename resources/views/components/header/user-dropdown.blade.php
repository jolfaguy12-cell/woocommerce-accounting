<div class="relative" x-data="{
    ...
    <button
        ...
        type="button"
    >
        <span class="ml-3 overflow-hidden rounded-full h-11 w-11">
    ...
    <div
        ...
        class="absolute left-0 mt-[17px] flex w-[260px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark z-50"
        style="display: none;"
    >
        <!-- User Info -->
        <div>
